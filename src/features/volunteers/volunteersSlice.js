...
const fetchVolunteers = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get(
      "https://volunteer-management-application-backend.rajkishan.repl.co/volunteer"
    );
...
const updateVolunteerAsync = createAsyncThunk(
  ...
  async ({ id, updatedVolunteer }) => {
    await axios.put(
      `https://volunteer-management-application-backend.rajkishan.repl.co/volunteer/${id}`,
      updatedVolunteer
    );
